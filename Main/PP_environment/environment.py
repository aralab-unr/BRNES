...
class Env:
    ...
    def reset(self, playMode, noTarget, noAgent, noObs, noFreeway, gridHeight, gridWidth, epochVal, CriteriaVal, countVal, neighborWeights, totalEpisode,LoopVal):
        ...
        with open("/Users/mdtamjidhossain/Dropbox/Projects/Papers/Journal 2/Code/final_code/Attempt5/Submission/IROS 2023/BRNES_supplementary_files/BRNES-main/Main/RandomPosition/C"+str(0)+ "_L"+str(LoopVal)+
